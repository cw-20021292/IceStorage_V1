...
typedef enum
{
    ...
    WIFI_ERROR_0049_COMP_CURRENT_SENSING = 0x0049,
    WIFI_ERROR_004A_COMP_STARTING_FAIL,
    WIFI_ERROR_004B_COMP_OVER_CURRENT,
    WIFI_ERROR_004C_COMP_OVERHEAT,
    WIFI_ERROR_004D_COMP_DISCONNECTION_OF_COMM,
    WIFI_ERROR_004E_COMP_ABNORMAL_VOLTAGE,
